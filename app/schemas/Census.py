...
class CensusSchema(BaseModel):
    ...
    Entity_Log_Ref2_Name: Optional[str | int | None] = Field(None, description="Ref 2 name")
    Entity_Log_Ref3_Name: Optional[str | int | None] = Field(None, description="Ref 3 name")
    Entity_Log_Ref3_Type: Optional[str | int | None] = Field(None, description="Ref 3 type")
