...
class CensusSchema(BaseModel):
    ...
    Entity_Visible: Optional[str] = Field(
        None, description="Determines if is visible Y if it is N if is not")
    Entity_Status: Optional[str] = Field(None, description="Status of entity")
    Entity_Name: Optional[str] = Field(
        None, description="Social name of the entity")
    Entity_Address_Short: Optional[str] = Field(
        None, description="Address of the entity")
    ...
    Entity_Stat_Activity_Code: Optional[int] = Field(
        0, description="Activity Code")
    Entity_Size_Emp: Optional[str] = Field(None, description="Business size")
    Entity_Log_Ref1_Type: Optional[str | int |
                                   None] = Field(None, description="Ref 1")
    Entity_Log_Ref2_Type: Optional[str | int | None] = Field(
        None, description="Ref 2 type")
    Entity_Log_Ref2_Name: Optional[str | int | None] = Field(
        None, description="Ref 2 name")
    Entity_Log_Ref3_Name: Optional[str | int | None] = Field(
        None, description="Ref 3 name")
    Entity_Log_Ref3_Type: Optional[str | int | None] = Field(
        None, description="Ref 3 type")
    Entity_Address_StType: Optional[str] = Field(None, description="Type")
    Entity_Address_StName: Optional[str | Any] = Field(None, description="St Name")
    Entity_Address_Number: Optional[int] = Field(
        None, description="Number of address")
    Entity_Address_SectorType: Optional[str] = Field(
        None, description="Square address")
    Entity_Address_SectorName: Optional[str | Any] = Field(
